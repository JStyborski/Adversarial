...
from FastGradMethod_ProjectedGradDesc import *
...
#perturb, x_adv = fast_gradient_method(model, imgTens, alpha, norm, loss, x_min=0., x_max=1., y=labelTens, targeted=targeted)
perturb, x_adv = projected_gradient_descent(model, imgTens, alpha, eps, nb_iter, norm, loss, x_min=0., x_max=1.,
                                            y=labelTens, targeted=targeted, rand_init=rand_init, noise_minmax=None)
